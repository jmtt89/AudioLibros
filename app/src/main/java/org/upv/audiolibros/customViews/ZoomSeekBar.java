package org.upv.audiolibros.customViews;
...
public class ZoomSeekBar extends View {
    ...
    //Listener de eventos
    @Nullable
    OnCambioValorListener listener;
    ...
    public void setOnCambioValorListener(OnCambioValorListener listener) {
